...
const calcXP = (score, total, timeSeconds, integrityPct) => {
  ...
  const speedBonus =
    timeSeconds < total * 35 ? 30 : timeSeconds < total * 50 ? 15 : 0;
...
export default function BoardTestResult({
  ...
  const masteryData =
    subjectMastery && Object.keys(subjectMastery).length
  ...
  return (
    <div
      ...
      style={{
        minHeight: "100vh",
        background: "linear-gradient(180deg, #F8F7FF 0%, #F8FAFC 100%)",
        color: "#111827",
      }}
    >
      <style>{`
          ...
          >
            ...
            >
              <div>
                <p
                  className="mono"
                  style={{ color: "#7C3AED", margin: "0 0 6px" }}
                >
                ...
                >
                  Your board practice is complete. Review your performance and
                  improve for the next attempt.
                </p>
              </div>
              <div
                style={{
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            <SectionCard
              ...
              subtitle="A concise view of execution, clarity, and readiness"
              accent="#7C3AED"
            >
              <div
                style={{
              ...
              >
                <MetricCard
                  ...
                  value={speedLabel}
                  hint="Pacing"
                  accent={speedLabel === "Fast" ? "#059669" : "#6B7280"}
                />
                <MetricCard
                  label="Accuracy"
                  value={accuracyLabel}
                  hint="Answer confidence"
                  accent={
                    accuracyLabel === "High"
                      ? "#059669"
                ...
                <MetricCard
                  ...
                  hint="Understanding"
                  accent={
                    conceptLabel === "Satisfactory" ? "#0369A1" : "#D97706"
                  }
                />
                <MetricCard
                  label="Readiness"
                  ...
                  hint="Exam fit"
                  accent={
                    readinessLabel === "Nearly Ready" ? "#059669" : "#DC2626"
                  }
                />
              </div>
              {delta !== null && (
                ...
                >
                  {delta >= 0 ? "▲" : "▼"} {Math.abs(delta)}% change from your
                  previous attempt.
                </div>
              )}
            </SectionCard>
            ...
            <SectionCard
              ...
              subtitle="A practical read on how the session performed"
              accent="#0F766E"
            >
              <div
                ...
                {[
                  {
                    ...
                    value: Math.min(100, percentage + 8),
                    color: "#7C3AED",
                  },
                  {
                    label: "Accuracy control",
                    value: Math.min(100, percentage + 4),
                    color: "#2563EB",
                  },
                  {
            ...
            <SectionCard
              ...
              subtitle="Performance by focus area"
              accent="#2563EB"
            >
              <div
                style={{ display: "flex", flexDirection: "column", gap: 12 }}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            <SectionCard
              title="Exam details"
              subtitle="Context for this attempt"
              accent="#334155"
            >
              <div
                style={{ display: "flex", flexDirection: "column", gap: 10 }}
